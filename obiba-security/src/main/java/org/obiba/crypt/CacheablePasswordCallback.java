...
public class CacheablePasswordCallback extends PasswordCallback {
  ...
  public static class Builder {
    ...
    public CacheablePasswordCallback build() {
      if (passwordKey == null || passwordKey.isEmpty()) throw new IllegalArgumentException("key must not be null or empty");
      if (prompt == null || prompt.isEmpty()) throw new IllegalArgumentException("prompt must not be null or empty");
