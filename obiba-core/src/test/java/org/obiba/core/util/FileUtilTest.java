...
public class FileUtilTest {
  ...
  public void testZipBasedFolder() throws IOException {
    ...
    verifyEntry(output, "zip-test" + File.separator + "file0.txt", "This is test file 0, avec des caractères accentués.");
  }
  ...
  public void testEncryptedZipFolder() throws IOException, DataFormatException {
    ...
    verifyEntry(output, "zip-test" + File.separator + "file0.txt", "password", "This is test file 0, avec des caractères accentués.");
  }
