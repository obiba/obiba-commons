...
public class ConfigurationFactoryBean implements InitializingBean, FactoryBean {
	...
	private static final Logger log = LoggerFactory.getLogger(ConfigurationFactoryBean.class);
	...
	private ConfigScope generateUUIDs = null;
  ...
  private boolean transparentActivation; 
	...
	public void afterPropertiesSet() throws Exception {
		...
		if (generateUUIDs != null)
			configuration.generateUUIDs(generateUUIDs);
    ...
    if(transparentActivation) {
      configuration.add(new TransparentActivationSupport());
      configuration.reflectWith(new JdkReflector(ConfigurationFactoryBean.class.getClassLoader()));
    }
	 ...
	 */
	public void setGenerateUUIDs(ConfigScope generateUUIDs) {
  ...
  public void setTransparentActivation(boolean activate) {
    this.transparentActivation = activate;
  }
