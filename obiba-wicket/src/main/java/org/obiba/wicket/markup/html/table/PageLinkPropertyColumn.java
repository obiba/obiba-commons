 ...
 */
public class PageLinkPropertyColumn extends PropertyColumn {
   ...
   */
  public PageLinkPropertyColumn(IModel displayModel, String sortProperty, String propertyExpression, Class<? extends Page> pageClass, String key, String valuePropertyExpression) {
  ...
  public PageLinkPropertyColumn(IModel displayModel, String propertyExpression, Class<? extends Page> pageClass, String key, String valuePropertyExpression) {
  ...
  public void populateItem(Item item, String componentId, final IModel model) {
    ...
    Object value = PropertyResolver.getValue(propertyExpression, model);
    if(value == null) throw new IllegalArgumentException("Property ["+propertyExpression+"] value is null for object ["+model+"]: cannot create page link.");
    parameters.add(this.key, value.toString());
    item.add(new LinkPanel(componentId, pageClass, parameters, createLabelModel(model)));
  }
