...
public class PageLinkPropertyColumn<T> extends PropertyColumn<T> {
   ...
   */
  public PageLinkPropertyColumn(IModel<String> displayModel, String sortProperty, String propertyExpression,
      Class<? extends Page> pageClass, String key, String valuePropertyExpression) {
  ...
  public PageLinkPropertyColumn(IModel<String> displayModel, String propertyExpression, Class<? extends Page> pageClass,
      String key, String valuePropertyExpression) {
